...
[0xHacked](https://0xHacked.com) is a trustless bug bounty platform where the whitehat can submit the proof of exploit to claim a bug bounty without disclosing any details through the zero-knowledge proof. We aspire to safeguard the interests of whitehats and ensure they receive a deserved bounty for their findings and efforts. Furthermore, we aim to transform the relationship between hackers and projects by fostering dialogue rather than destruction. We hope you have an enjoyable experience at [0xHacked](https://0xHacked.com). Enjoy hacking!
...
Upload your proof binary file to [0xHacked](https://0xHacked.com), or send us the proof on Telegram (https://HackedLabs.t.me), which ends with `.bin`. We'll check the token balance change and state diff once uploaded and confirm the exploit asap.
