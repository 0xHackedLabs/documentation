...
[0xHacked](https://0xHacked.com) is a trustless bug bounty platform where the white hat can submit the proof of exploit to claim a bug bounty without disclosing any details through the zero-knowledge proof. We aspire to safeguard the interests of white hats and ensure they receive a deserved reward for their findings and efforts. Furthermore, we aim to transform the relationship between hackers and projects by fostering dialogue rather than destruction. We hope you have an enjoyable experience at [0xHacked](https://0xHacked.com).
