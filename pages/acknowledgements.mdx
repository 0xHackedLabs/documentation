...
We stand on their shoulders to complete this project, especially [RISC Zero](https://github.com/risc0/risc0). We run an EVM inside the zkVM based on [RISC Zero](https://github.com/risc0/risc0).
